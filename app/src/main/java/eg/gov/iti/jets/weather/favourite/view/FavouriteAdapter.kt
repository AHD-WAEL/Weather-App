...
class FavouriteAdapter(private var favouriteLocation: List<FavoriteLocation>, var deleteFromFav:(FavoriteLocation) -> Unit, var favToHome:(FavoriteLocation) -> Unit): RecyclerView.Adapter<FavouriteAdapter.ViewHolder>() {
